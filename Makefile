...
topdir = .
BUILD_DIR = /home/love/work/builditem/bash-4.2
top_builddir = /home/love/work/builditem/bash-4.2
srcdir = .
VPATH = .


CC = /home/love/work/arm-linux463/bin/arm-none-linux-gnueabi-gcc
CC_FOR_BUILD = gcc
YACC = bison -y
SHELL = /bin/sh
CP = cp
...
LDFLAGS = -static -static -L./lib/termcap -L./lib/termcap $(STATIC_LD) $(LOCAL_LDFLAGS) $(PROFILE_FLAGS) $(CFLAGS)
...
RL_INCLUDEDIR = /home/love/work/armbin/include
